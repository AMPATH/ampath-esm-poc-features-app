          ...
          {loading ? (
            ...
            <>
              <Tabs>
                <TabList>
                  <Tab>HIV Summary</Tab>
                  <Tab>Historical HIV Summary</Tab>
                  <Tab>Viral Load and Treatment Changes Tracker</Tab>
                </TabList>
                <TabPanels>
                  <TabPanel>{latestHivSummary && <LatestHivSummary hivSummary={latestHivSummary} />}</TabPanel>
                  <TabPanel>{hivSummary && <HistoricalHivSummary hivSummaries={hivSummary} />}</TabPanel>
                  <TabPanel>
                    {medicationHistoryChange && (
                      <MedicationChangeHistorySummary medicationChangeHistory={medicationHistoryChange} />
                    )}
                  </TabPanel>
                  <TabPanel>Hiv Clinical Summary</TabPanel>
                  <TabPanel>Previous Visit Summary</TabPanel>
                  <TabPanel>AHD Events Summary</TabPanel>
                </TabPanels>
              </Tabs>
            </>
          )}
